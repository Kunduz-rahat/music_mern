...
<nav id="header" className="w-full z-30 top-10 py-1 bg-white shadow-lg border-b border-blue-400 mt-4">
         ...
         <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
            <nav>
               <div className="md:flex items-center justify-between text-base text-blue-600 pt-4 md:pt-0">
                  ...
                  <NavLink className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2"to="#">Products</NavLink>
                  <NavLink className="inline-block no-underline hover:text-black font-medium text-lg py-2 px-4 lg:-ml-2" to="#">About</NavLink>
               </div>
            </nav>
         </div>
